...
interface GlobalStylingModalDesktopModeProps extends Omit<GlobalStylingModeProps, 'mode'> {
  title: string
}

export function GlobalStylingModalDesktopMode({ content, title }: GlobalStylingModalDesktopModeProps) {
  ...
  return (
    <div>
      ...
      >
        ...
        {/* Modal Content */}
        <div style={{ padding: '16px' }} className="emtlkit-modal__customizer-content">
          {/* Product Image Section */}
          <div style={{ width: '160px', height: '160px' }} className="emtlkit-modal__product-image-container">
            <div className="emtlkit-modal__product-image">
              <img
