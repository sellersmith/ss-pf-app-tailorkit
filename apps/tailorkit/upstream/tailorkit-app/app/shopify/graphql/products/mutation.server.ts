...
/**
 * @see https://shopify.dev/docs/api/admin-graphql/2025-10/mutations/tagsAdd
 */
export const tagsAddMutation = `#graphql
...
/**
 * @see https://shopify.dev/docs/api/admin-graphql/2025-10/mutations/tagsRemove
 */
export const tagsRemoveMutation = `#graphql
