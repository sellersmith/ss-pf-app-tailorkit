 ...
 *
 * Functions for path manipulation, hit testing, and Bezier curve operations.
 ...
 */
export function closestPointOnBezierCurve(
  point: Point,
  start: Point,
  end: Point,
  cp1?: Point,
...
/**
 * Path type for segment operations
 */
 ...
 */
export function insertNodeIntoPath<T extends ParsedPath>(path: T, segmentIndex: number, position: Point, t: number): T {
  const commands = [...path.commands]
