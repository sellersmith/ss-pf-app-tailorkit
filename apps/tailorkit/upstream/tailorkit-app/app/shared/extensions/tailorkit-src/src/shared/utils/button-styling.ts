...
export function applyOptionSetVariables(optionSet: OptionSetInput | undefined, setVar: SetVarFn): void {
  ...
  // Option border
  setVar('--emtlkit-option-border-active-color', option.borderActiveColor ?? DEFAULTS.optionSet.option.borderActiveColor)
...
export function applyBoxVariables(box: BoxInput | undefined, setVar: SetVarFn): void {
  setVar('--emtlkit-box-background-color', box?.backgroundColor ?? DEFAULTS.box.backgroundColor)
  ...
  setVar('--emtlkit-box-border-width', `${box?.borderWidth ?? DEFAULTS.box.borderWidth}px`)
