/**
 * Font Swatch Element - Chunk Version
 *
 ...
 */
import { BaseOptionSetElement, FontLoader } from './BaseWrapper'
import type { FontOptionItem } from '../../shared/components/FontOptionSet/types'

// Create a local font loader instance for the chunk
const fontStorefrontLoader = new FontLoader()
