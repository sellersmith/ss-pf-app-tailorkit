...
interface MockupWizardTourProps {
  flow: GuidedTourFlow
  active: boolean
  onClose: () => void
}
...
/**
 * Reusable tour component for MockupWizard tours (toolbar + vector).
 * Follows the "always show until Don't Show Again" pattern.
 */
export default function MockupWizardTour({ flow, active, onClose }: MockupWizardTourProps) {
