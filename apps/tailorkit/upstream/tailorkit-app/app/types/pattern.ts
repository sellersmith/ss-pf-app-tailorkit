 ...
 *
 * Shared types for scatter patterns and distributed effects.
 * Extracted from VectorEditor for reuse across modules.
 */

/**
 * Scatter point with transform properties
 */
...
export interface PatternConfig {
  ...
  seed?: number
  /** Number of scattered instances (default: 10) */
  count?: number
  /** Distribution density 0-1 (default: 0.5) */
  density?: number
  /** Rotation range in degrees */
  rotation?: { min: number; max: number }
  /** Scale variation (default: 0.5-1.5) */
  scale?: { min: number; max: number }
  /** Color palette for variation */
  colors?: readonly string[] | string[]
  /** Distribution type */
  distribution?: 'random' | 'grid' | 'radial' | 'spiral'
}
